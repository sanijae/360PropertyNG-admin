...
import { AdminPanelSettings, Message, VerifiedUserSharp } from "@mui/icons-material";
...
export const navLinks = [
  ...
  { name: "Users", url: "/users", icon: <PeopleAltOutlinedIcon /> },
  { name: "Agent", url: "/agent", icon: <VerifiedUserSharp /> },
  ...
  { name: "Admins", url: "/admins", icon: <AdminPanelSettings /> },
